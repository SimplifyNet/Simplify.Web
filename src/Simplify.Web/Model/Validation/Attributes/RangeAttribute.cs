...
public class RangeAttribute(IComparable minValue, IComparable maxValue, string? errorMessage = null, bool isMessageFromStringTable = true) : ValidationAttribute(errorMessage, isMessageFromStringTable)
{
	/// <summary>
