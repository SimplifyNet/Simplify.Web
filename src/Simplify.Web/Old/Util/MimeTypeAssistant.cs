...
{
	/// <summary>
	/// The extensions to MIME types relation
	/// </summary>
	public static readonly IDictionary<string, string> ExtensionsToMimeTypesRelation = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
	{
		{ ".323", "text/h323" },
		{ ".3g2", "video/3gpp2" },
		{ ".3gp", "video/3gpp" },
	...
	/// <summary>
	/// The MIME types to extensions relation
	/// </summary>
	...
	/// </summary>
	/// <param name="fileExtension">The file extension (with of without dot).</param>
	/// <returns></returns>
	/// <exception cref="ArgumentException">Value cannot be null or empty. - fileExtension</exception>
	...
	/// <param name="throwErrorIfNotFound">if set to <c>true</c> then the exception will be thrown.</param>
	/// <returns></returns>
	/// <exception cref="ArgumentException">
	/// Value cannot be null or empty. - mimeType
	/// or
