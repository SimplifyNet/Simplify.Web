...
using Simplify.Web.Meta.Controllers.MetaStore.Extensions;
...
public class ControllersMetaStore : IControllersMetaStore
{
	...
	public ControllersMetaStore(IMetadataLoader loader)
	{
		...
		Controller400 = items.GetHandlerController(HandlerControllerType.Http400Handler);
	...
	public IControllerMetadata? Controller400 { get; }
